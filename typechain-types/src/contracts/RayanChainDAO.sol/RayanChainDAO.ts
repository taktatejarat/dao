...
export interface RayanChainDAOInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "FUNDING_DURATION",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "SOFT_CAP_PERCENT",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "finalizeFunding",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace FundingFinalizedEvent {
...
export interface RayanChainDAO extends BaseContract {
  ...
  FUNDING_DURATION: TypedContractMethod<[], [bigint], "view">;

  MAX_RISK_SCORE: TypedContractMethod<[], [bigint], "view">;

  SOFT_CAP_PERCENT: TypedContractMethod<[], [bigint], "view">;
  ...
  finalizeFunding: TypedContractMethod<
    [_proposalId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  invest: TypedContractMethod<
    [_proposalId: BigNumberish, _amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "FUNDING_DURATION"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "MAX_RISK_SCORE"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "SOFT_CAP_PERCENT"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "finalizeFunding"
  ): TypedContractMethod<[_proposalId: BigNumberish], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    key: "FundingFinalized"
  ): TypedContractEvent<
    FundingFinalizedEvent.InputTuple,
    FundingFinalizedEvent.OutputTuple,
    FundingFinalizedEvent.OutputObject
  >;
  getEvent(
    key: "Initialized"
  ): TypedContractEvent<
  ...
  filters: {
    "FundingFinalized(uint256,bool,uint256)": TypedContractEvent<
      FundingFinalizedEvent.InputTuple,
      FundingFinalizedEvent.OutputTuple,
      FundingFinalizedEvent.OutputObject
    >;
    FundingFinalized: TypedContractEvent<
      FundingFinalizedEvent.InputTuple,
      FundingFinalizedEvent.OutputTuple,
      FundingFinalizedEvent.OutputObject
    >;
    ...
    "InvestmentReceived(uint256,address,uint256)": TypedContractEvent<
      InvestmentReceivedEvent.InputTuple,
      InvestmentReceivedEvent.OutputTuple,
      InvestmentReceivedEvent.OutputObject
    >;
