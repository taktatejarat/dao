...
export interface IFinanceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "daoAddress"
      | "investments"
...
export interface IFinance extends BaseContract {
  connect(runner?: ContractRunner | null): IFinance;
  waitForDeployment(): Promise<this>;

  interface: IFinanceInterface;
