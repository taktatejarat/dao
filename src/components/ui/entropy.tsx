...
export function Entropy({ className = "", size = 400 }: EntropyProps) {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      update() {
        if (this.order) {
          // Motion of ordered particles under the influence of chaos
          const dx = this.originalX - this.x
          const dy = this.originalY - this.y

          // Calculate the effects from chaotic particles
          ...
          // Mixed ordered motion and chaotic effects
