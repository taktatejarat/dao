...
export interface RayanChainTimelockControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface RayanChainTimelockController extends BaseContract {
  connect(runner?: ContractRunner | null): RayanChainTimelockController;
  waitForDeployment(): Promise<this>;

  interface: RayanChainTimelockControllerInterface;
