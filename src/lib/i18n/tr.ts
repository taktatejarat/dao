...
export const tr = {
  ...
  reports_page: {
    ...
    subtitle: "Her teklif için derinlemesine analizler ve yapay zeka tabanlı tahminler.",
    card_title: "Akıllı Teklif Analizi",
    card_desc: "Yapay zeka motorundan tam bir analitik rapor almak için istenen teklifin ID'sini girin.",
