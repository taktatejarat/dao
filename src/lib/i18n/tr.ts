...
wallet: {
  ...
  dashboard: {
    ...
    no_proposals: "Hiç teklif bulunamadı",
  ...
  proposals: {
    ...
    new: {
      ...
      subtitle: "Vizyonunuzu tanımlayın veya hazine kaynaklarını yönetin",
      tab_startup: "Startup Yatırım Talebi",
      tab_treasury: "DAO Yönetimi (Hazine)",

      stage_title: "Projenin Aşaması",
      stage_idea: "Fikir / Ön gelir",
      stage_idea_desc: "Prototip (MVP), araştırma ve geliştirme",
      stage_revenue: "Büyüme / Gelir sonrası",
      stage_revenue_desc: "Aktif gelir elde etme, pazar genişletme",

      kb_title: "Teknoloji Sınıflandırması",
      kb_none: "Normal (Teknoloji tabanlı değil)",
      kb_type1: "Yeni girişim (Tip 1)",
      kb_type2: "Teknoloji odaklı (Tip 2)",
      kb_creative: "Yaratıcı / Kültür ve yaratıcı endüstriler",

      docs_title: "Belgeler",
      upload_pitch: "Pitch Deck Yükle",
      upload_whitepaper: "Whitepaper / İş Planı Yükle",
      upload_legal: "Hukuki Belgeler",
      required: "(Zorunlu)",
      uploaded: "Yüklendi",

      project_details: "Proje Detayları",
      project_details_desc: "Yatırımcılara sunduğunuz değer önerisini açıklayın.",
      lbl_name: "Projenin Adı",
      ph_name: "Örnek: RayanChain",
      lbl_tagline: "Kısa Slogan",
      ph_tagline: "Örnek: Merkeziyetsiz yatırımın geleceği",
      lbl_problem_solution: "Sorun ve Çözüm",
      ph_problem_solution: "Mevcut sorun nedir ve siz bunu nasıl çözüyorsunuz?",

      market_financials: "Pazar ve Finans",
      market_desc_idea: "Pazar büyüklüğü ve yakım oranı odaklı",
      market_desc_revenue: "Gelir ve büyüme metrikleri odaklı",
      lbl_tam: "Toplam Erişilebilir Pazar (TAM) – $",
      lbl_sam: "Hizmet Verilebilir Pazar (SAM) – $",
      lbl_som: "Elde Edilebilir Pazar Payı (SOM) – $",

      lbl_burn_rate: "Aylık Yakım Oranı ($)",
      lbl_runway: "Runway Süresi (ay)",
      lbl_revenue: "Geçen Yılki Gelir ($)",
      lbl_profit: "Kâr Marjı (%)",

      milestones_title: "Yatırım Aşamaları",
      milestones_desc: "Yatırımın nasıl kullanılacağını tanımlayın.",
      lbl_milestone_name: "Aşama Adı",
      lbl_days: "Süre (gün)",
      lbl_amount: "Tutar (RYC)",
      btn_add_milestone: "Aşama Ekle",
      btn_submit_startup: "Yatırım Talebini Gönder",

      treasury_title: "Para Çekme Talebi",
      treasury_desc: "Para çekme veya parametre değiştirme teklifi oluşturun.",
      lbl_proposal_title: "Teklif Başlığı",
      lbl_desc_reason: "Açıklama ve Gerekçe",
      lbl_recipient: "Alıcı Adresi",
      lbl_token_type: "Token Türü",
      opt_governance: "RYC (yönetim)",
      opt_native: "Yerel Token",
      btn_submit_treasury: "DAO Teklifini Gönder",
      ph_wallet: "0x...",
      ...
      success_desc: "İşlem gönderildi. Hash:",
      form_invalid_error: "Lütfen tüm alanları doğru şekilde doldurun.",
      form_incomplete_title: "Form eksik doldurulmuş",
      form_incomplete_tooltip: "Lütfen tüm bölümlerdeki zorunlu alanları doldurun.",
      contract_not_deployed_title: "Sözleşme dağıtılmamış",
      contract_not_deployed_desc: "DAO sözleşmesi henüz dağıtılmadı. Lütfen yöneticiyle iletişime geçin.",
      loading: "Yükleniyor...",
      back_to_dashboard: "Panele dön",
      invalid_address: "Lütfen geçerli bir Ethereum adresi girin (0x + 40 karakter).",
      valid_address: "Ethereum adresi geçerli.",
      recipient_required: "Lütfen geçerli bir alıcı adresi girin.",

      blockchain_role_missing_title: "Blockchain rolü eksik",
      blockchain_role_missing_desc: "Teklif göndermek için DAO_MEMBER_ROLE rolüne sahip olmanız gerekir. Yöneticiyle iletişime geçin.",
      request_role_button: "Rol Talep Et",
      grant_role_error_title: "Rol Verilemedi",
      grant_role_error_desc: "Gerekli rol atanamadı. Lütfen yöneticiyle iletişime geçin.",
      grant_role_info_title: "Rol talebi gönderildi",
      grant_role_info_desc: "Talebiniz yöneticiler tarafından incelenecek.",
      contract_write_error: "Teklif gönderimi başarısız. Lütfen tekrar deneyin.",
      access_denied_title: "Erişim reddedildi",
      access_denied_desc: "Teklif göndermek için 'startup' rolüne sahip olmalısınız.",
      connect_to_submit: "Teklif göndermek için cüzdanınızı bağlayın.",

      ai_check_triggered: "Yapay zekâ risk analizi başlatıldı.",
      ai_check_failed_title: "Yapay zekâ etkinleştirme hatası",
      ai_check_failed_desc: "Risksiz manuel kontrol yapılacaktır. Yapay zekâ kontrolü başarısız oldu.",

      redirecting: "Yönlendiriliyor...",
      success_toast_title: "İşlem başarıyla gönderildi",
      confirmed_toast_desc: "İşlem blockchain üzerinde onaylandı",
      pending_toast_title: "İşlem işleniyor",
      error_toast_title: "İşlem hatası",
      unexpected_error_desc: "Bilinmeyen bir hata oluştu. Lütfen logları kontrol edin.",

      company_info: "Şirket ve Ekip Bilgileri",
      company_info_desc: "Şirket tescil bilgileri ve ekip yapısı.",
      lbl_company_reg_id: "Şirket Kayıt Numarası / Ulusal Kimlik",
      lbl_founded_date: "Kuruluş Tarihi",
      lbl_team_size: "Ekip Büyüklüğü",
      lbl_demo_url: "Demo / MVP Bağlantısı",
      lbl_linkedin: "Şirket / Kurucu LinkedIn",
      lbl_last_year_revenue: "Geçen Yıl Elde Edilen Gelir",
      lbl_net_profit: "Net Kâr (Geçen yıl)",
      lbl_ebitda: "Faaliyet Kâr Marjı (EBITDA)",
      lbl_valuation: "Önerilen Değerleme (Pre-Money)",
  ...
  staking_page: {
    ...
    your_staked_balance: "Stake edilmiş bakiyeniz",
    wallet_balance: "Cüzdan bakiyesi",
    manage_staking: "Stake yönetimi",
    manage_desc: "Token yatırın veya çekin ve pasif gelir elde edin.",
    tab_stake: "Stake",
    tab_unstake: "Geri çekme",
    tab_claim: "Ödül talebi",
    approve_token: "Token iznini onayla",
    stake_button: "Token stake et",
    unstake_button: "Stakeden çık",
    available_rewards: "Mevcut ödüller",
    claim_rewards_button: "Ödülleri talep et",
    staking_info_title: "Neden stake yapmalıyız?",
    staking_info_desc: "Stake işlemi tokenlerinizi ağ güvenliği için kilitler. Oy hakkı (1:1) ve protokol gelirlerinden pay alırsınız.",
    governance_power: "Yönetim gücü",
    self_delegated: "Kendime delegasyon",
    delegate_to_address: "Adrese delege et",
    delegate_button: "Oy hakkını delege et",
    undelegate_button: "Delegasyonu kaldır",
  ...
  toasts: {
    ...
    submitting_claim: "Ödüller alınıyor...",
    submitting_delegate: "Oy yetkisi devrediliyor...",
    submitting_undelegate: "Delege kaldırılıyor...",
    unstake_successful: "Geri çekme başarıyla tamamlandı.",
