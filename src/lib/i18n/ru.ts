...
export const ru = {
  ...
  security_report:{
    normal_behavior: "В шаблонах поведения этого пользователя не обнаружено подозрительной активности или аномалий",
  ...
  time: {
    ...
    recommendation: {
    low_risk_desc: "Оценивается как привлекательная инвестиционная возможность с низким уровнем риска",
    medium_risk_desc: "Проект имеет хороший потенциал но связан со средним риском Рекомендуется дальнейшее изучение",
    high_risk_desc: "Эта инвестиция связана с высоким риском и требует очень тщательного анализа",
    low: "низкий",
    medium: "средний",
    high: "высокий",
    very_high: "очень высокий",
    ...
    strong_financials: "Финансовая модель и экономические прогнозы проекта оцениваются как сильные",
    top_factor: "Ключевой фактор принятия решения {{factor}}",
    },
    weakness: {
