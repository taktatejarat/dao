...
export const ar = {
  ...
  time: {
    ...
    yesterday: "أمس",
      ...
      recommendation: {
      low_risk_desc: "تم تقييم فرصة استثمارية جذابة ذات مخاطر منخفضة.",
      medium_risk_desc: "يتمتع المشروع بإمكانيات جيدة ولكنه مرتبط بمخاطر متوسطة. يوصى بإجراء مزيد من البحث.",
      high_risk_desc: "هذا الاستثمار مرتبط بمخاطر عالية ويتطلب بحثًا دقيقًا ودقيقًا للغاية.",
      low: "منخفض",
      medium: "متوسط",
      high: "عالي",
      very_high: "عالي جدًا",
      ...
      xai: {
      strength: {
      strong_team: "يتمتع فريق المشروع بخبرة عالية.",
