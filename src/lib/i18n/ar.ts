...
wallet: {
  ...
  role_selection: {
    ...
    voter: "مصوّت",
    delegate: "مندوب",
    investor_desc_short: "تقييم فرص الاستثمار مع التركيز على الربحية وإدارة المخاطر",
    subtitle: "يتيح لك اختيار الدور تحديد مكانك داخل هيكل الحوكمة والاستثمار ورسم مسار المشاركة بما يتوافق مع أهدافك وقدراتك وقد صُمم هذا القسم لتعزيز الوضوح في عملية اتخاذ القرار لكي يتمكن كل عضو من أداء دور فعّال داخل الشبكة",
    continue_to_staking_cta: "المتابعة لاختيار خطة الاستثمار",
    delegate_title: "مندوب الحوكمة",
    delegate_desc: "المشاركة الفعالة في اتخاذ قرارات DAO من خلال الحصول على حق التصويت بالوكالة من الأعضاء الآخرين والتأثير على مستقبل الاستثمارات.",
  ...
  new_proposal_page: {
    ...
    file_limits_title: "قيود الملفات",
    file_limits_desc: "الحد الأقصى لحجم كل ملف هو 20 ميغابايت. يمكنك إرفاق ما يصل إلى 5 ملفات إضافية.",
    additional_files: "ملفات إضافية (اختياري)",
    add_more_files: "إضافة ملف آخر",
    max_files_reached: "تم الوصول إلى الحد الأقصى لعدد الملفات المسموح بها.",
