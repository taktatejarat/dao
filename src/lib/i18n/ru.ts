...
wallet: {
  ...
  secure_connection_note: "Подключая кошелёк вы принимаете правила платформы",
  tab_recommended: "Рекомендуемые",
  tab_others: "Другие",
  no_other_wallets: "Других кошельков не найдено",
  connection_failed: "Подключение не удалось",
  click_to_connect: "Нажмите чтобы подключиться",
  desc_metamask: "Браузерное расширение и мобильное приложение",
  desc_walletconnect: "Сканирование кода любым кошельком",
  desc_coinbase: "Подтверждено Coinbase",
  badge_mobile: "Мобильный",
  ...
  dashboard: {
    ...
    no_proposals: "Предложений не найдено",
  ...
  proposals: {
    ...
    platform_x_partnership: "Партнерство с платформой X",
      new: {
        ...
        subtitle: "Определите свое видение или управляйте ресурсами казначейства",
        tab_startup: "Привлечение инвестиций для стартапа",
        tab_treasury: "Управление DAO (Казначейство)",

        stage_title: "Стадия проекта",
        stage_idea: "Идея / Доход отсутствует",
        stage_idea_desc: "Прототип (MVP), исследования и разработка",
        stage_revenue: "Рост / После появления дохода",
        stage_revenue_desc: "Активное получение дохода, расширение рынка",

        kb_title: "Классификация по знанию",
        kb_none: "Обычный (не инновационный)",
        kb_type1: "Начальный (Тип 1)",
        kb_type2: "Технологический (Тип 2)",
        kb_creative: "Креативный / Индустрии soft skills",

        docs_title: "Документы",
        upload_pitch: "Загрузить Pitch Deck",
        upload_whitepaper: "Загрузить Whitepaper / бизнес-план",
        upload_legal: "Юридические документы",
        required: "(Обязательно)",
        uploaded: "Загружено",

        project_details: "Детали проекта",
        project_details_desc: "Опишите ваше ценностное предложение для инвесторов",
        lbl_name: "Название проекта",
        ph_name: "Например: RayanChain",
        lbl_tagline: "Короткий слоган",
        ph_tagline: "Например: Будущее децентрализованных инвестиций",
        lbl_problem_solution: "Проблема и решение",
        ph_problem_solution: "В чем проблема и как вы ее решаете",

        market_financials: "Рынок и финансы",
        market_desc_idea: "Фокус на размере рынка и burn rate",
        market_desc_revenue: "Фокус на доходах и показателях роста",
        lbl_tam: "Общий доступный рынок (TAM) – $",
        lbl_sam: "Доступный обслуживаемый рынок (SAM) – $",
        lbl_som: "Доля достижимого рынка (SOM) – $",

        lbl_burn_rate: "Месячный Burn Rate ($)",
        lbl_runway: "Runway (месяцы)",
        lbl_revenue: "Доход за прошлый год ($)",
        lbl_profit: "Маржа прибыли (%)",

        milestones_title: "Инвестиционные этапы",
        milestones_desc: "Определите, как будут использованы средства",
        lbl_milestone_name: "Название этапа",
        lbl_days: "Длительность (дни)",
        lbl_amount: "Сумма (RYC)",
        btn_add_milestone: "Добавить этап",
        btn_submit_startup: "Отправить запрос на финансирование",

        treasury_title: "Запрос на вывод средств",
        treasury_desc: "Создайте предложение для вывода средств или изменения параметров",
        lbl_proposal_title: "Название предложения",
        lbl_desc_reason: "Описание и причина",
        lbl_recipient: "Адрес получателя",
        lbl_token_type: "Тип токена",
        opt_governance: "RYC (управление)",
        opt_native: "Внутренняя валюта",
        btn_submit_treasury: "Отправить предложение DAO",
        ph_wallet: "0x...",
        note_self_recipient: "Если оставить пустым, средства будут отправлены на ваш собственный кошелек",

        industries: {
          software: "Программные приложения",
          biotechnology: "Биотехнологии и здравоохранение",
          mobile: "Мобильное приложение",
          e_commerce: "Платформы электронной коммерции",
          enterprise: "Корпоративное программное обеспечение",
          other: "Программное обеспечение общего назначения",
        },
        ...
        business_models: {
            ...
            saas: "SaaS облачные программные сервисы",
        ...
        success_desc: "Транзакция отправлена. Хеш:",
        form_invalid_error: "Пожалуйста, заполните все поля правильно",
        form_incomplete_title: "Форма заполнена не полностью",
        form_incomplete_tooltip: "Пожалуйста, заполните все обязательные поля во всех разделах",
        contract_not_deployed_title: "Контракт не развернут",
        contract_not_deployed_desc: "Контракт DAO еще не развернут. Свяжитесь с администратором",
        loading: "Загрузка...",
        back_to_dashboard: "Вернуться на панель",
        invalid_address: "Введите действительный адрес Ethereum (0x + 40 символов)",
        valid_address: "Адрес Ethereum действителен",
        recipient_required: "Введите корректный адрес получателя",

        blockchain_role_missing_title: "Отсутствует роль в блокчейне",
        blockchain_role_missing_desc: "Для отправки предложений вам нужна роль DAO_MEMBER_ROLE. Свяжитесь с администратором",
        request_role_button: "Запросить роль",
        grant_role_error_title: "Ошибка выдачи роли",
        grant_role_error_desc: "Не удалось выдать нужную роль. Свяжитесь с администратором",
        grant_role_info_title: "Запрос роли отправлен",
        grant_role_info_desc: "Ваш запрос будет рассмотрен администратором",
        contract_write_error: "Ошибка отправки предложения в блокчейн. Повторите попытку",
        access_denied_title: "Доступ запрещен",
        access_denied_desc: "Для отправки предложения вам требуется роль ‘стартап’",
        connect_to_submit: "Подключите кошелек для отправки предложения",

        ai_check_triggered: "Запущен процесс оценки рисков ИИ",
        ai_check_failed_title: "Ошибка активации ИИ",
        ai_check_failed_desc: "Проверка будет выполнена вручную. Оценка рисков не удалась",
        ...
        error_toast_title: "Ошибка транзакции",
        unexpected_error_desc: "Произошла неизвестная ошибка. Проверьте логи",

        company_info: "Юридическая и командная информация",
        company_info_desc: "Регистрационные данные компании и структура команды",
        lbl_company_reg_id: "Регистрационный номер компании / Национальный ID",
        lbl_founded_date: "Дата основания",
        lbl_team_size: "Размер команды",
        lbl_demo_url: "Ссылка на демо / MVP",
        lbl_linkedin: "LinkedIn компании / основателя",
        lbl_last_year_revenue: "Доход за прошлый год",
        lbl_net_profit: "Чистая прибыль (прошлый год)",
        lbl_ebitda: "Операционная прибыль (EBITDA)",
        lbl_valuation: "Предварительная оценка (Pre-Money)",
  ...
  proposal_detail: {
    ...
    history_title: "История предложений",
    resubmit_title: "Пересмотр и повторная отправка",
    resubmit_desc: "Это предложение не получило необходимое количество голосов или финансирования. Вы можете создать новую доработанную версию с сохранением предыдущих данных и изменением условий например корректировкой бюджета или дополнением документации.",
    btn_resubmit: "Создать доработанную версию",
  ...
  staking_page: {
    ...
    your_staked_balance: "Ваш заблокированный баланс",
    wallet_balance: "Баланс кошелька",
    manage_staking: "Управление стейкингом",
    manage_desc: "Вносите или выводите токены и получайте пассивный доход.",
    tab_stake: "Стейкинг",
    tab_unstake: "Вывод",
    tab_claim: "Получение наград",
    approve_token: "Подтвердить доступ к токену",
    stake_button: "Стейкать токены",
    unstake_button: "Отменить стейкинг",
    available_rewards: "Доступные награды",
    claim_rewards_button: "Получить награды",
    staking_info_title: "Почему стоит стейкать токены?",
    staking_info_desc: "Стейкинг блокирует ваши токены для обеспечения безопасности сети. Вы получаете право голоса (1:1) и долю доходов протокола.",
    governance_power: "Вес голоса",
    self_delegated: "Делегировано себе",
    delegate_to_address: "Делегировать на адрес",
    delegate_button: "Делегировать голос",
    undelegate_button: "Отменить делегирование",
  ...
  treasury_page: {
    ...
    manage_funds_title: "Управление фондами",
    manage_funds_desc: "Вывод средств требует одобрения сообщества",
    secure_vault_title: "Безопасное хранилище активно",
    secure_vault_desc: "Все исходящие транзакции защищены Timelock и мультиподписным управлением",
    withdrawal_instruction: "Для вывода средств на операционные расходы или инвестиции необходимо подать официальный проект. После одобрения держателями токенов выполнение будет поставлено в очередь",
    create_withdrawal_proposal: "Создать проект на вывод средств",
    dao_governance_active: "Управление DAO активно",
    dao_governance_desc: "Этот казначейский фонд полностью децентрализован. Ни один администратор не имеет прямого доступа к средствам",
  },
  ...
  toasts: {
    ...
    submitting_claim: "Получение наград...",
    submitting_delegate: "Делегирование голоса...",
    submitting_undelegate: "Отмена делегирования...",
    unstake_successful: "Вывод успешно выполнен.",
    ...
    revision_mode: "Режим исправления и повторной подачи",
